...
FROM university.programs_students,
     university.programs,
     university.users
WHERE university.programs_students.program_id = university.programs.program_id
AND university.programs_students.user_id = university.users.user_id
AND university.programs.name = 'Ingeniería de Sistemas'
...
FROM university.users,
     university.roles
WHERE university.users.role_id = university.roles.role_id
AND university.roles.name = 'Professor';
...
FROM university.programs_courses,
     university.programs,
     university.courses
WHERE university.programs_courses.program_id = university.programs.program_id
AND university.programs_courses.course_id = university.courses.course_id
